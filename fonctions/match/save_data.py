...
class SaveDataMixin:
    ...
    def _insert_match_data(self):
        ...
        requete_perso_bdd(
            ...
            early_baron, allie_feeder, snowball, temps_vivant, dmg_tower, turret_plates_taken_total, gold_share, mvp, ecart_gold_team, "kills+assists", datetime, temps_avant_premiere_mort, "dmg/gold", ecart_gold, ecart_gold_min,
