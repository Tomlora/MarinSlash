...
mode_de_jeu = [create_choice(name='ranked', value='ranked'),
...
class Achievements_scoringlol(commands.Cog):
    ...
    async def achievements(self, ctx, mode:str, records:bool=False):
    ...
    async def achievements_regles(self, ctx, mode:str):
        ...
        embed = discord.Embed(title=f"** Règles {mode}: **", color=discord.Colour.gold())
